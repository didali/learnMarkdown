...
[^脚注：]:脚注是对文本的备注说明 `语法为：[^脚注：]:脚注是对文本的备注说明`
...
上述为`markdown`中一些常用的且不复杂语法，这些已经够我们写出一些漂亮的文档出来了，同时`markdown`支持创建公式、流程图、UML图、表格等许多语法，感兴趣可以自行了解。
